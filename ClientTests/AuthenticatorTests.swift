...
class MockMalformableLogin: LoginData {
    ...
    required init(guid: String, hostname: String, username: String, password: String) {
        self.guid = guid
...
class AuthenticatorTests: XCTestCase {
    ...
    func testChallengeMatchesSingleMalformedLoginEntry() {
        ...
        let malformedLogin = MockMalformableLogin.createWithHostname("malformed.com", username: "username", password: "password")
    ...
    func testChallengeMatchesDuplicateLoginEntries() {
        // Since Login has been updated to not store schemeless URL, write directly to simulate a malformed URL
        let malformedLogin = MockMalformableLogin.createWithHostname("malformed.com", username: "malformed_username", password: "malformed_password")
        logins.addLogin(malformedLogin).value

        let login = Login.createWithHostname("https://malformed.com", username: "good_username", password: "good_password")
        logins.addLogin(login).value
